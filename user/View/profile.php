    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <div class="content col-md-12">
                ...
                <form action="?action=edit_profile" method="post">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                <button class="btn btn-info float-right mr-2" type="reset">Bỏ</button>
                            </td>
                            <td>
                                <button class="btn btn-success ml-2" type="submit">Lưu</button>
                            </td>
                        </tr>
                    </table>
                </form>
